...
<nav>
        ...
        <ul>
            ...
            <li id="menu-item-notifications"><a href="<?php routeEcho('notification') ?>"><i class="covoiturage-notification"><span class="number-bubble">x</span></i>Notifications</a></li>
            <li id="compte-header">
                <a href="<?php routeEcho('profil') ?>">
                    ...
                    <span class="desktop-only">Bienvenue <?php //$user->getNomUtilisateur() . ' ' . $user->getPrenomUtilisateur() ?></span>
