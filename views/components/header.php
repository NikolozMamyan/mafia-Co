...
<nav>
    ...
    <ul>
        <li><a href="<?php //routeEcho('search') 
                        ?>"><i class="covoiturage-search"></i>Rechercher</a></li>
        <li id="menu-item-messagerie"><a href="<?php //routeEcho('chat') 
                                                ?>"><i class="covoiturage-messaging"><span class="number-bubble">x</span></i>Messagerie</a></li>
        <li id="menu-item-notifications"><a href="<?php //routeEcho('notify') 
                                                    ?>"><i class="covoiturage-notification"><span class="number-bubble">x</span></i>Notifications</a></li>
        <li id="compte-header">
