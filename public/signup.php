    ...
    <main>
        ...
        <div class="container-fluid">
            ...
            <form class="border row m-2">
                ...
                <!-- section utilisateur-->
                <section class="col-md-6 border bg__roundP--100 p-3">
                    <div class="container-fluid">
                        <div class="row ">
                            <!-- nom -->
                ...
                <section class="col-md-6 border">
                    <div class="row ">
                        ...
                        <div class="col-md-2 d-sm-none d-md-block d-flex justify-content-center  align-items-end">
                            <img src="../public/assets/images/arrows-left-right-solid.svg" class='flag__style ' alt="Fleche noire">
                        </div>
                        <div class="col-md-2 d-md-none d-sm-block d-flex justify-content-start  align-items-center">
                            <img src="../public/assets/images/arrows-up-down-solid.svg" class='flag__style ' alt="Fleche noire">
                        </div>
                        <div class="col-md-5 row">
