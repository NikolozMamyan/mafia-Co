...
INSERT INTO `itineraire` (`idItineraire`, `adresseDepart`, `adresseArrivee`, `debutCours`, `finCours`, `nbrPlaceDispo`, `infoComplementaire`, `dateCreation`, `derniereModificationTrajet`, `idPointDepart`, `idPointArrivee`) VALUES
...
INSERT INTO `itinerairejoursemaine` (`idItineraire`, `idJourSemaine`) VALUES
	(2, 1),
	(4, 1),
	(7, 1),
	(8, 1),
...
INSERT INTO `points` (`idPoint`, `nomVille`, `codePostalVille`, `latitude`, `longitude`) VALUES
...
INSERT INTO `utilisateurs` (`idUtilisateur`, `nomUtilisateur`, `prenomUtilisateur`, `adresseUtilisateur`, `telUtilisateur`, `emailUtilisateur`, `motDePasseUtilisateur`, `photoUtilisateur`, `compteActif`, `dateInscriptionUtilisateur`, `derniereModificationUtilisateur`, `idItineraire`, `idRole`, `idPoint`) VALUES
